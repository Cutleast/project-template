...
LICENSES: dict[str, str] = {
    ...
    "PySide6": "https://code.qt.io/cgit/pyside/pyside-setup.git/tree/LICENSES?h=6.9.1",
    ...
    "virtual-glob": "https://pypi.org/project/virtual_glob/",
}
"""A dict of all used libraries and URL to their license/website."""
